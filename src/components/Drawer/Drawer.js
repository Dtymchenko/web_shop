...
const Drawer = ({ onCardClose, items = [], onRemoveItem }) => {
    return (
        <div className='drawer_overlay' onClick={onCardClose}>
            <div className='drawer' onClick={(e)=> e.stopPropagation()}>
                <h2>
                    Basket
                    <svg onClick={onCardClose} version="1.0" xmlns="http://www.w3.org/2000/svg"
...
25 -156 18z"/>
                ...
                {
                    items.length > 0 ? <div className='fragment'>
                    ...
                    items.map((obj) => (
                        ...
                        key={obj.id}
                        >
                        <img width={50} height={50} src={obj.imageURL} alt='Goods'></img>
                        <div className='basket_item_text'>
                        <p>{obj.title}</p>
                        <b>{obj.price + " USD"}</b>
                        </div>
                    <div className='basket_item_remove' onClick={() => onRemoveItem(obj.id)}>
